...
#'   minimize the influence of the number of samples.
...
#'   close to the sample also in the low-dimensional representation.
...
#'   (Kraemer and Reichstein 2018, Lee et al. 2009, Chen and Buja 2006).
